...
| `tahun2-bc-zonghe` | Tahun 2 | 华文 (bc) | 华文勇者大冒险 | 跨22个知识点的综合复习（未单列 DSKP 代码） | https://tahun2-bc-zonghe-3z8g2goax-kongsi-idea.vercel.app | `../teaching-tools/tahun2-bc-zonghe/` | 220题、22站、三档难度与公开排行榜；当前为 Vercel preview，Kongsi Idea 团队默认 SSO 保护，正式公开使用前需确认访问设定与朋友原作／插画授权。 |
