...
**一眼看出的缺口**（2026-07-21 更新）：14 个工具，Tahun 1/2 数学+华文仍最密集，Tahun 2 数学一个年级就占了 5 个（钱币/数位/数列×3/乘法），但每个工具教学场景不同（solo/双人/整班），不算重复堆砌。**新增了第一个科学工具**（`tahun1-dst-magnet`，不是老师投稿，是直接照 DSKP 内容标准自主开发的——见下方说明）。**英文（bi）、历史/设计与工艺/伊斯兰/道德/视觉艺术/音乐/体育 这 7 个科目仍然完全空白**；数学 Tahun 3/5/6、华文 Tahun 2/4/5/6、马来文 Tahun 2-6、科学 Tahun 2-6 也都还空着。下次找素材/构思新工具时优先看这些空科目/年级。
