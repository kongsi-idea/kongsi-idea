...
| `tahun2-bc-zonghe` | Tahun 2 | 华文 (bc) | 华文勇者大冒险 | 跨22个知识点的综合复习（未单列 DSKP 代码） | https://tahun2-bc-zonghe.vercel.app | `../teaching-tools/tahun2-bc-zonghe/` | 220题、22站、三档难度与公开排行榜；正式工具域名已建立；真实班级成绩流程与李老师原作／插画授权仍需保留确认记录。 |
