...
| `tahun1-bc-bishun` | 一起写好字 | Tahun 1 | 华文 | ⚠️ 引用异常：3.0 书写技能 — 3.1 | 已上架 | 待评估 | 1.0 | 资料异常 | 有 | — | 老师本机+电脑室实测确认笔顺判定松紧、三步流程节奏、音效音量；等课堂反馈 | 2026-09-09 |
...
| 年级 | 已上架工具 |
|---|---|
| Tahun 1 | 马来文 1 个（KVKV音节打地鼠）；华文 6 个（一起写好字、部首大对垒、句型跳跳队、量词大冒险、识字大对决、神奇句子小火车）；数学 1 个（近似值特快车）；科学与科技世界 1 个（磁铁大发现） |
