...
| `tahun1-bc-liangci` | 量词大冒险 | Tahun 1 | 华文 | 5.0 语文基础知识 — 5.3.1 | 已上架 | 待评估 | 1.1 | 已同步 | 无 | — | 等待课堂反馈；有不满意之处时在这里登记 | 2026-07-24 |
...
| 年级 | 已上架工具 |
|---|---|
| Tahun 1 | 马来文 1 个（KVKV音节打地鼠）；华文 5 个（部首大对垒、句型跳跳队、量词大冒险、识字大对决、神奇句子小火车）；数学 1 个（近似值特快车）；科学与科技世界 1 个（磁铁大发现） |
