...
| `tahun2-bc-zonghe` | 开发中 | 待评估 | 尚未用真实班级与访客完成一次成绩写入／读取验证；尚未初始化 GitHub 远端或部署 preview；朋友提供的生成插画公开发布授权仍需确认 | 建立 GitHub／Vercel preview → 老师点击验收 → 用真实班级与访客验证成绩 → 上架 Hub |
...
| `tahun2-bc-zonghe` | 华文勇者大冒险 | Tahun 2 | 华文 | 待核对 | 开发中 | 待评估 | — | 未上架，不需同步 | 有 | 尚未用真实班级与访客完成一次成绩写入／读取验证；尚未初始化 GitHub 远端或部署 preview；朋友提供的生成插画公开发布授权仍需确认 | 建立 GitHub／Vercel preview → 老师点击验收 → 用真实班级与访客验证成绩 → 上架 Hub | 2026-09-21 |
